		...
		<div class="bodytext_area box_inner">
			...
			<form method="POST" name="board_update" action="/home/board/board_update" class="appForm" encType="multipart/form-data">
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content">
								<textarea name="content" id="content_lbl" class="w100p" placeholder="내용을 입력해주세요." required><c:out value="${boardVO.content}"></c:out></textarea></div>
						</li>
						<li class="clear">
					...
					<a href="/home/board/board_view?page=${pageVO.page}&bno=${boardVO.bno}" class="btn_baseColor">이전 화면</a>
					</p>	
				</fieldset>
