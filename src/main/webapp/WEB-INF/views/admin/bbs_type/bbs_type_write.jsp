              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" name="board_type" id="board_type" placeholder="게시판타입을 입력해 주세요." required>
                  </div>
                  <div class="form-group">
	...
	jQuery("#board_type").bind("blur",function(){
		if(jQuery(this).val() != "") {
			...
			if(jQuery.inArray(jQuery(this).val(),board_type_array) >= 0) {//자바변수값과 input 게시판타입값 비교해서 있으면
				...
				alert("기존 이름을 가진 게시판이 존재 합니다. 다시 입력해 주세요");
