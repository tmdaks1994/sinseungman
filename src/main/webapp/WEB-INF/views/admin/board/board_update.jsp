    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <c:forEach var="index" begin="0" end="1">
	                  <div class="div_file_delete"> <!-- 폴더삭제+DB삭제+화면삭제용 -->
          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
            	<a href="/admin/board/board_view?page=${pageVO.page}&bno=${boardVO.bno}" class="btn btn-primary float-right mr-1">view info</a>
...
$(document).ready(function(){
	$(".btn_file_delete").on("click",function(){
		if(confirm("첨부파일을 삭제 하시겠습니까?")){
			...
			$.ajax({
				type:"post",//get방식으로 지우면, 누구나 URL입력시 지우는것이 가능
