...
public class CommonController {
	...
	@Inject
	IF_BoardDAO boardDAO;//첨부파일을 입력/삭제하기 위해
	/**
	...
	baos.close();//스프링프레임워크 기반의 프로그램구조에서는 close와 같은 메모리관리가 할 필요없음. = 스프링에는 가비지컬렉트기능이 내장.
	...
	public String fileUpload(MultipartFile file) throws IOException {
		...
		return saveFileName;//copy로 업로드 이후에 저장된 real_file)_name스트링문자열  1개를 반환.
	}
