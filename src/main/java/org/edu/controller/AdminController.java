...
public class AdminController {
	//@Inject의존성 주입방식 DI으로 외부 라이브러리 모듈 클래스 인스턴스 가져다 쓰기
	@Inject
	...
	public String board_list(Model model) throws Exception {
		...
		// input_board2 = {2,"두번째 게시물 입니다.","두번째 내용
		// 입니다.<br>줄바꿈했습니다.","user02",now(),2,0};
	...
	public String member_list(Model model) throws Exception {
		String[][] members = { { "admin", "찐관리자", "admin@abc.com", "true", "2020-12-04", "ROLE_ADMIN" },
